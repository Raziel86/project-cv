...
public class TestDataController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		User admin1 = new User("Admin1", "admin1@dawan.fr", "admin1", true);
//		User u2 = new User("user2", "prenUtil1", "user2@dawan.fr", "user2", "rue d ela paix lille", "066666",
//				new Date());
...
//		
//		ExperiencesPro exp1 = new ExperiencesPro("developpeur java", new Date(), new Date(), "blebleble");
//		exp1.setCv(cv1);
//		cv1.getXp().add(exp1);
//		
//		
...
//		
//		
//		CentresInterets ci1 = new CentresInterets("vtt");
//		ci1.setCv(cv1);
